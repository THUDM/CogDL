...
CogDL是由清华大学计算机系知识工程实验室（KEG）的[唐杰教授](http://keg.cs.tsinghua.edu.cn/jietang/)所主持的基于图的深度学习的研究工具（[主页](http://keg.cs.tsinghua.edu.cn/cogdl/), [代码库](https://github.com/THUDM/cogdl), [文档](https://cogdl.readthedocs.io/)，[海报](https://qibinc.github.io/cogdl-leaderboard/poster.pdf)），基于Python语言和[Pytorch](https://github.com/pytorch/pytorch)库进行开发。
