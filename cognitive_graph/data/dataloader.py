...
from cognitive_graph.data import Batch


class DataLoader(torch.utils.data.DataLoader):
    r"""Data loader which merges data objects from a
    :class:`cognitive_graph.data.dataset` to a mini-batch.
...
class DataListLoader(torch.utils.data.DataLoader):
    r"""Data loader which merges data objects from a
    :class:`cognitive_graph.data.dataset` to a python list.

    .. note::

        This data loader should be used for multi-gpu support via
        :class:`cognitive_graph.nn.DataParallel`.
