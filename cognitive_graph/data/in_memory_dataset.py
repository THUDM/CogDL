...
import torch
from cognitive_graph.data import Dataset, Data


class InMemoryDataset(Dataset):
    r"""Dataset base class for creating graph datasets which fit completely
    into memory.
    See `here <https://rusty1s.github.io/pycognitive_graph/build/html/notes/
    ...
    Args:
        ...
        pre_filter (callable, optional): A function that takes in an
            :obj:`cognitive_graph.data.Data` object and returns a boolean
    ...
    def collate(self, data_list):
        ...
        format of :class:`cognitive_graph.data.InMemoryDataset`."""
