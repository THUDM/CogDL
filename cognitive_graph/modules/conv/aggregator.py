...
from cognitive_graph.modules.conv import MessagePassing
from cognitive_graph.utils import remove_self_loops, add_self_loops
...
class Meanaggregator(MessagePassing):
    ...
    def __init__(self,
                 ...
                 cached=False,
                 bias=True):
        super(Meanaggregator, self).__init__('add')
