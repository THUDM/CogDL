...
def hypersearch_gcn_best(trial):
    return {
        ...
        "num_layers": trial.suggest_categorical("num_layers", [10]),
...
if __name__ == "__main__":
    ...
    if False:
        experiment(
            ...
            seed = list(range(1)),
            split = list(range(10)),
            search_space = hypersearch_gcn_best,
            n_trials = 1,
            project = 'hypersearch',
            devices = [-1],
            # trial_log_path = './logs/trial/hypersearch_citeseergeom_gcn_classic_try100.log',
