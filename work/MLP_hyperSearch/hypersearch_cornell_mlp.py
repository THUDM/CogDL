...
def hypersearch_mlp_cornell_all(trial):
    return {
...
def hypersearch_mlp_cornell_classic(trial):
    return {
...
def hypersearch_mlp_cornell_best(trial):
    return {
...
if __name__ == "__main__":
    ...
    if False:
        experiment(
            ...
            seed = list(range(1)),
            split = list(range(10)),
            search_space = hypersearch_mlp_cornell_best,
            n_trials = 1,
            project = 'hypersearch',
            devices = [-1],
            # trial_log_path = './logs/trial/hypersearch_cornell_mlp_classic_try100.log',
