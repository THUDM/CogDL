...
def hypersearch_mlp_texas_all(trial):
    return {
...
def hypersearch_mlp_texas_classic(trial):
    return {
...
def hypersearch_mlp_texas_best(trial):
    return {
...
if __name__ == "__main__":
    ...
    if False:
        experiment(
            ...
            seed = list(range(1)),
            split = list(range(10)),
            search_space = hypersearch_mlp_texas_best,
            n_trials = 1,
            project = 'hypersearch',
            devices = [-1],
            # trial_log_path = './logs/trial/hypersearch_texas_mlp_classic_try100.log',
